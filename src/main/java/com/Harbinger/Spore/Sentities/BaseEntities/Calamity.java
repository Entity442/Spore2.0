...
public class Calamity extends UtilityEntity {
    ...
    public static final EntityDataAccessor<String> AIORDER = SynchedEntityData.defineId(Calamity.class, EntityDataSerializers.STRING);
    ...
    public void addAdditionalSaveData(CompoundTag tag) {
        ...
        tag.putString("aiorder",entityData.get(AIORDER));
    ...
    public void readAdditionalSaveData(CompoundTag tag) {
        ...
        entityData.set(AIORDER, tag.getString("aiorder"));
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(AIORDER,"0");
    }
