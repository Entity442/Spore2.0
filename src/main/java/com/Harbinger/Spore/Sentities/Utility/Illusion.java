...
public class Illusion extends UtilityEntity implements Enemy, ArmorPersentageBypass {
    ...
    public DamageSource getCustomDamage(LivingEntity entity) {
        return this.getSeeAble() ? super.getCustomDamage(entity) : new EntityDamageSource("mental_damage",entity);
    }
