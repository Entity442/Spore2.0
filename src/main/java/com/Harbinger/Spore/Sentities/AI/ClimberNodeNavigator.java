...
public class ClimberNodeNavigator extends NodeEvaluator {
    ...
    @Override
    public BlockPathTypes getBlockPathType(BlockGetter var1, int var2, int var3, int var4, Mob var5, int p_77342_, int p_77343_, int p_77344_, boolean p_77345_, boolean p_77346_) {
    ...
    protected BlockPathTypes getCachedBlockType(Mob $$0, int $$1, int $$2, int $$3) {
        return this.pathTypesByPosCache.computeIfAbsent(BlockPos.asLong($$1, $$2, $$3), $$4 -> this.getBlockPathType(this.level, $$1, $$2, $$3));
    }
}