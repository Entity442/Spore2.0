...
public class SkullSoupItem extends BlockItem {
    public SkullSoupItem(Block block) {
        super(block, new Item.Properties().tab(ScreativeTab.SPORE).food(new FoodProperties.Builder().nutrition(4).saturationMod(2F)
