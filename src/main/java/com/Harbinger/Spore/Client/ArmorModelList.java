...
public class ArmorModelList {
    ...
    public static List<Quad> modelItemMap(HumanoidModel<LivingEntity> humanoidModel){
        ...
        map.add(new Quad(EquipmentSlot.FEET, Sitems.LIVING_BOOTS.get().asItem(),humanoidModel.leftLeg,livingEntityfleshArmorModel,livingEntityfleshArmorModel.leftBoot,-0.1f,-0.8f,0,1f));
        map.add(new Quad(EquipmentSlot.FEET, Sitems.LIVING_BOOTS.get().asItem(),humanoidModel.rightLeg,livingEntityfleshArmorModel,livingEntityfleshArmorModel.rightBoot,0.1f,-0.8f,0,1.01f));
        map.add(new Quad(EquipmentSlot.LEGS, Sitems.LIVING_PANTS.get().asItem(),humanoidModel.leftLeg,livingEntityfleshArmorModel,livingEntityfleshArmorModel.leftLeg,-0.1f,-0.8f,0,1f));
        map.add(new Quad(EquipmentSlot.LEGS, Sitems.LIVING_PANTS.get().asItem(),humanoidModel.rightLeg,livingEntityfleshArmorModel,livingEntityfleshArmorModel.rightLeg,0.1f,-0.8f,0,1.01f));
        map.add(new Quad(EquipmentSlot.LEGS, Sitems.LIVING_PANTS.get().asItem(),humanoidModel.body,livingEntityfleshArmorModel,livingEntityfleshArmorModel.pelvis,0,0,0,1f));
        map.add(new Quad(EquipmentSlot.CHEST, Sitems.LIVING_CHEST.get().asItem(),humanoidModel.body,livingEntityfleshArmorModel,livingEntityfleshArmorModel.body,0,0,0,1f));
        map.add(new Quad(EquipmentSlot.CHEST, Sitems.LIVING_CHEST.get().asItem(),humanoidModel.rightArm,livingEntityfleshArmorModel,livingEntityfleshArmorModel.rightArm,0.25f,-0.125f,0,1f));
        map.add(new Quad(EquipmentSlot.CHEST, Sitems.LIVING_CHEST.get().asItem(),humanoidModel.leftArm,livingEntityfleshArmorModel,livingEntityfleshArmorModel.leftArm,-0.25f,-0.125f,0,1f));
        map.add(new Quad(EquipmentSlot.HEAD, Sitems.LIVING_HELMET.get().asItem(),humanoidModel.head,livingEntityfleshArmorModel,livingEntityfleshArmorModel.headwear,0f,0f,0,1f));
        ...
        map.add(new Quad(EquipmentSlot.OFFHAND, Sitems.PCI.get().asItem(), humanoidModel.leftArm, pciL, pciL.PCIBODY, 0.15f, -0.35f, 0.05f, 1f));  return map;
    }
