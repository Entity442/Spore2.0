package com.Harbinger.Spore.Client.Models;// Made with Blockbench 4.7.1
...
public class StalkerModel<T extends Stalker> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r3 = leg2.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(52, 0).addBox(-1.5F, 0.0F, 0.0F, 3.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 1.0F, -0.2618F, 0.0F, 0.0F));
		...
		PartDefinition spine2 = body.addOrReplaceChild("spine2", CubeListBuilder.create().texOffs(0, 16).addBox(-4.5F, -5.5F, -4.25F, 9.0F, 6.0F, 6.0F, new CubeDeformation(-0.3F))
		.texOffs(42, 39).addBox(-3.0F, -6.0F, -1.25F, 0.0F, 14.0F, 11.0F, new CubeDeformation(0.0F))
		.texOffs(42, 39).addBox(3.0F, -6.0F, -1.25F, 0.0F, 14.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -3.0F, 0.25F, 0.1745F, 0.0F, 0.0F));
		...
		PartDefinition cube_r7 = arm2.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(14, 50).addBox(-1.5F, 0.25F, -1.0F, 3.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, -2.0F, 0.2182F, 0.0F, 0.0F));
