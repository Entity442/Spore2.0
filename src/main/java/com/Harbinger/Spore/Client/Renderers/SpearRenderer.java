...
public class SpearRenderer extends EntityRenderer<ThrownSpear> {
    ...
    public void render(ThrownSpear spear, float p_116112_, float p_116113_, PoseStack p_116114_, MultiBufferSource p_116115_, int p_116116_) {
        float r = 1;
        float g = 1;
        float b = 1;
        ...
        p_116114_.pushPose();
        p_116114_.mulPose(Vector3f.YP.rotationDegrees(Mth.lerp(p_116113_, spear.yRotO, spear.getYRot()) - 90.0F));
        p_116114_.mulPose(Vector3f.ZP.rotationDegrees(Mth.lerp(p_116113_, spear.xRotO, spear.getXRot()) + 90.0F));
        ...
        this.model.renderToBuffer(p_116114_, vertexconsumer, p_116116_, OverlayTexture.NO_OVERLAY, r, g, b, 1.0F);
        p_116114_.popPose();
        super.render(spear, p_116112_, p_116113_, p_116114_, p_116115_, p_116116_);
    }
