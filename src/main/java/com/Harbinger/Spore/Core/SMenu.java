...
public class SMenu {
    ...
    public static final RegistryObject<MenuType<AssimilationMenu>> ASSIMILATION_MENU = MENU.register("injection_menu", () -> IForgeMenuType.create(AssimilationMenu::new));
