...
public class Sblocks {
    ...
    public static final RegistryObject<Block> LAB_BLOCK1 = BLOCKS.register("lab_block1", () -> new Block(BlockBehaviour.Properties.of(Material.STONE).strength(6f, 20f)));
    public static final RegistryObject<Block> LAB_BLOCK2 = BLOCKS.register("lab_block2", () -> new Block(BlockBehaviour.Properties.of(Material.STONE).strength(6f, 20f)));
    public static final RegistryObject<Block> LAB_BLOCK3 = BLOCKS.register("lab_block3", () -> new Block(BlockBehaviour.Properties.of(Material.STONE).strength(6f, 20f)));
    ...
    public static final RegistryObject<Block> VENT_DOOR = BLOCKS.register("vent_door",() -> new TrapDoorBlock(BlockBehaviour.Properties.of(Material.WOOD).sound(SoundType.METAL).strength(2f, 4f).noOcclusion().sound(SoundType.METAL)));
    ...
    public static final RegistryObject<Block> REINFORCED_DOOR = BLOCKS.register("reinforced_door",() -> new DoorBlock(BlockBehaviour.Properties.of(Material.METAL).sound(SoundType.METAL).strength(20f, 1200.0F).noOcclusion().sound(SoundType.METAL)));
    public static final RegistryObject<Block> RUSTED_REINFORCED_DOOR = BLOCKS.register("rusted_reinforced_door",() -> new DoorBlock(BlockBehaviour.Properties.of(Material.METAL).sound(SoundType.METAL).strength(10f, 600.0F).noOcclusion().sound(SoundType.METAL)));
    public static final RegistryObject<Block> FROZEN_REINFORCED_DOOR = BLOCKS.register("frozen_reinforced_door",() -> new DoorBlock(BlockBehaviour.Properties.of(Material.METAL).sound(SoundType.METAL).strength(15f, 800.0F).noOcclusion().sound(SoundType.METAL)));
    ...
    public static final RegistryObject<Block> INFESTED_RED_SAND = BLOCKS.register("infested_red_sand", () -> new SelectableFallingBlock(BlockBehaviour.Properties.copy(Blocks.RED_SAND)));
    ...
    public static final RegistryObject<Block> ROTTEN_STAIR = BLOCKS.register("rotten_stair", () -> new StairBlock(()-> ROTTEN_PLANKS.get().defaultBlockState(),BlockBehaviour.Properties.copy(Sblocks.ROTTEN_PLANKS.get())));
    public static final RegistryObject<Block> ROTTEN_SLAB = BLOCKS.register("rotten_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(Blocks.OAK_PLANKS).sound(SoundType.WOOD)));
    ...
    public static final RegistryObject<Block> ROTTEN_BUSH = BLOCKS.register("rotten_bush", () -> new GenericFoliageBlock( BlockBehaviour.Properties.of(Material.WOOD).sound(SoundType.CROP).strength(0f, 0f).noCollission().noOcclusion().sound(SoundType.CROP)){
        @Override
        ...
        @Override
        public int getFireSpreadSpeed(BlockState state, BlockGetter world, BlockPos pos, Direction face) {return 15;}});
    ...
    public static final RegistryObject<Block> SICKEN_BIOMASS_BLOCK = BLOCKS.register("sicken_biomass_block", () -> new SickenBiomassBlock(BlockBehaviour.Properties.of(Material.MOSS).strength(4f,4f).sound(SoundType.SLIME_BLOCK)));
    public static final RegistryObject<Block> GASTRIC_BIOMASS_BLOCK = BLOCKS.register("gastric_biomass_block", () -> new GastricBiomassBlock(BlockBehaviour.Properties.of(Material.MOSS).strength(4f,4f).sound(SoundType.SLIME_BLOCK)));
    public static final RegistryObject<Block> CALCIFIED_BIOMASS_BLOCK = BLOCKS.register("calcified_biomass_block", () -> new Block(BlockBehaviour.Properties.of(Material.MOSS).strength(8f,20f).sound(SoundType.SLIME_BLOCK)));
    ...
    public static final RegistryObject<Block> FUNGAL_SHELL = BLOCKS.register("fungal_shell", () -> new Block(BlockBehaviour.Properties.of(Material.MOSS).strength(20f,6f).sound(SoundType.BONE_BLOCK)));
